        ...
        <div className="w-11/12 mx-auto">
          ...
          <form>
            <div className="pt-8 xl:pt-32 lg:grid lg:grid-cols-2 gap-12">
              <div className="xl:max-w-[616px] p-8 border rounded-xl space-y-5 bg-section-bg-gray border-form-border">
                <div>
              ...
              <div className="xl:max-w-[648px] py-8 xl:py-0 xl:p-8 flex flex-col justify-between">
