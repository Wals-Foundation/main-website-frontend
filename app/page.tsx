...
export default function Home() {
  ...
  const pageHeadlinesSlugMap = createSlugMap(data.pageHeadlines)
        ...
        <div className="w-11/12 mx-auto xl:flex justify-between items-start">
          {pageControlSlugMap.get("home_headline") && (
            <div className="max-w-[681px]">
              <Typography type="Title">
                {pageHeadlinesSlugMap.get("home_headline") || "Creating pathways to opportunity for every community"}
              </Typography>
            </div>
          )}
          ...
          <div className="max-w-[436px] pt-10 xl:pt-0">
            {pageControlSlugMap.get("home_subheadline") && (
              <Typography>
                {pageHeadlinesSlugMap.get("home_subheadline") ||
